...
###  mpas-bundle rel 2.0.0  >>>  rel. 1.0.0   ##  dev may24   ##  oops @develop may24
...
export JEDI_SRC=${JEDI_ROOT}/mpas-bundle-rel2.0.0   ## path to mpas-bundle release 2.0.0 was download from git
export JEDI_BUILD=${JEDI_ROOT}/build_mpas2-0-0-gnu9-modules   ## path to build the JEDI mpas-bundle package
